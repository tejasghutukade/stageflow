...
- [`tests/fixtures/pipelines/`](../tests/fixtures/pipelines/) — linear, parallel fan-out, HITL, fork routing, clonable fan-out, feedback loops, validation edge cases (`*.pipeline.yaml`)
